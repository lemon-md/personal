...
public class Digests {
    ...
    public static String http_da_calc_HA1(String username, String realm, String password,
        ...
        byte[] md5Byte1 = md5(HA1.getBytes());
        HA1 = new String(Hex.encodeHex(md5Byte1));

        byte[] md5Byte2 = md5(HA2(method, uri).getBytes());
        HA2 = new String(Hex.encodeHex(md5Byte2));

        // String original = HA1 + ":" + (nonce + ":" + nc + ":" + cnonce + ":" + qop) + ":" + HA2;
        String original = HA1 + ":" + nonce + ":" + HA2;
        byte[] md5Byte = md5(original.getBytes());
    ...
    public static void main(String[] args) throws UnsupportedEncodingException {
        String s = http_da_calc_HA1("ApiAdmin", "Huawei.com", "xinlu123321",
                                    "d83cc8f06414d35f03ab2be4b4feb6d0", "", "", "",
                                    "GET", "/SDCAPI/V1.0/MiscIaas/System?ChannelId=101", "MD5");
